        ...
        <div className="flex flex-col justify-between items-center md:flex-row md:justify-between md:items-center">
          ...
          <div className="w-full h-full md:w-[65%] ">
            <h3 className="text-center text-lg md:text-2xl md:text-left text-title font-semibold mb-4">
              I am a junior self-taught Front End Developer who is passionate
              about his work.
            </h3>
            <p className="text-center text-base md:text-left text-paragraph">
              I enjoy creating web pages and user interfaces. I interact well
              with other people, I am continuosly looking for solutions to
              problems,learning new technologies and willing to keep improving.
              Nowadays improving my php and php framework skills.
            </p>
          </div>
        </div>
      </div>
